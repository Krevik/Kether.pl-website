...
export function useMapsTranslations() {
    ...
    return {
        ...
        sortLabel: t('maps.sortLabel'),
        sortByName: t('maps.sortByName'),
        sortByInstalledAt: t('maps.sortByInstalledAt'),
        sortDirectionAscendingTooltip: t('maps.sortDirectionAscendingTooltip'),
        sortDirectionDescendingTooltip: t('maps.sortDirectionDescendingTooltip'),
        ...
        infoTooltip: t('maps.infoTooltip'),
        infoTitle: t('maps.infoTitle'),
